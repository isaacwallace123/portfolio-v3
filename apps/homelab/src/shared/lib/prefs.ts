export interface HomeOpsPrefs {
  reduceMotion: boolean;
  reduceTransparency: boolean;
  highContrast: boolean;
}

export const DEFAULT_PREFS: HomeOpsPrefs = {
  reduceMotion: false,
  reduceTransparency: false,
  highContrast: false,
};

const KEY = "iw:homelab:prefs";

export function getPrefs(): HomeOpsPrefs {
...
export function applyPrefs(prefs: HomeOpsPrefs = getPrefs()): void {
...
export function setPrefs(patch: Partial<HomeOpsPrefs>): HomeOpsPrefs {
