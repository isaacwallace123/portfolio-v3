  ...
  return (
    <section className={`${styles.card} ${styles.ratingBoard}`}>
      <div
        ...
        role="group"
        aria-label="Seasonless operator ladder. Scroll horizontally if needed."
        tabIndex={0}
      >
        <table className={styles.table}>
          <caption className={styles.visuallyHidden}>
            Seasonless operator ladder ranked by ELO
          </caption>
          <thead>
            <tr>
              <th>#</th>
      ...
      <p className={styles.scrollHint}>Scroll to see the complete ladder</p>
    </section>
  );
}
